                ...
                <div class="col-md-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input name="size" id="size" class="form-control" placeholder="Enter size" value="{{$product->size}}">
                                        <p class="error"></p>
                                    </div>
                                </div>
                                <div class="col-md-12">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <h6 class=" mt-2 float-right">Note:Upload Only JPEG Image <a href="https://converter.11zon.com/en/image-to-jpeg" target="_blank">JPEG convert</a> </h6> 
                        </div>               	                                                                      
                    </div>
                    
                    <div class="row" id="product-gallery">  
                        @if ($product2Image->isNotEmpty())
                            @foreach ($product2Image as $image)
                            <div class="col-md-3" id="image-row-{{$image->id}}">
                                <div class="card">
                                    <input type="hidden" name="image_array[]" value="{{$image->id}}">
                                    <img src="{{asset('public/uploads/product/small/'.$image->image)}}" class="card-img-top" alt="Image ID: {{$image->id}}">
                                    <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <input class="custom-control-input" value="Yes" {{($product->track_qty =='Yes') ? 'checked' : ''}}
...
$("#title").change(function(){
    ...
    $("#productForm").submit(function(event){
        ...
        $("button[type='submit']").prop('disabled',true);
        $.ajax({
            url:'{{ route("products2.update",$product->id)}}',
            type:'put',
            data:formArray,
            datatype:'json',
            success: function(response){
...
const dropzone = new Dropzone("#image", {
    url: "{{ route('products2-images.update') }}",
    maxFiles: 10,
    paramName: 'image',
            ...
            var html = `
                <div class="col-md-3" id="image-row-${response.image_id}">
                    <div class="card">
                        ...
                        <img src="${response.ImagePath}" class="card-img-top" alt="image2">
                        <div class="card-body">
...
function deleteImage(id) {
    if (confirm("Are you sure you want to delete image ?")) {
        $.ajax({
            url: '{{ route('products2-images.destroy') }}',
            type: 'delete',
            data: {
                id: id,

                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" value="{{ $coupon->min_amount}}"  name="min_amount" id="min_amount" class="form-control" placeholder="Minimum amount">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" autocomplete="off" value="{{ $coupon->starts_at}}"  name="starts_at" id="starts_at" class="form-control" placeholder="Select Started Date">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" autocomplete="off"  value="{{ $coupon->expires_at}}" name="expires_at" id="expires_at" class="form-control" placeholder="Select expires At">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">

                    ...
                    @foreach ($categories as $category )
                        ...
                        <tr>
                            ...
                            <td>    
                                ...
                                <div>
                                    <div>
                                        <img  width="50px"  src="{{$category->image? asset('public/uploads/category/thumb/'.$category->image):''}}" class="img-thumbnail"  alt="Not Found">      
                                    </div>
                                </div>
                                @else
                            ...
                            <td>{{$category->showHome ? $category->showHome:''}}</td>
                            <td>

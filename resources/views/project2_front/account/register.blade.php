        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (response.status === false) {
                    ...
                    $("#name, #email, #password, #password_confirmation").siblings("p").removeClass('invalid-feedback').html('');
                    $("#name, #email, #password, #password_confirmation").removeClass('is-invalid').addClass('is-valid');
                    // Let's redirect or show success message here

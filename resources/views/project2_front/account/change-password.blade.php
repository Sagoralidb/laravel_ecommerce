                    ...
                    <form action="" method="post" name="changePasswordForm" id="changePasswordForm">
                        ...
                        <div class="card-body p-4">
                            <div class="row">
                                ...
                                <div class="d-flex">
                                    <button name="submit" id="submit" type="submit" class="btn btn-dark">Save</button>
                                </div>
                            </div>
                        </div>
                </form>
      ...
      $("#changePasswordForm").submit(function(event) {
        ...
        $.ajax({
          ...
          success: function(response) {
            ...
            if (response.status) {
              window.location.href = "{{route('account.changePassword')}}"; // Redirect on success
            } else {
              var errors = response.errors;
              $("#changePasswordForm .is-invalid").removeClass('is-invalid');
              $("#changePasswordForm .invalid-feedback").text(''); // Clear previous errors
    
              // Loop through errors and update input fields

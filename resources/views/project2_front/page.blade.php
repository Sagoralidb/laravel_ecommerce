...
@section('script')
    ...
    <script>
        $("#contactForm").submit(function(event){
            ...
            submitButton.html('<i class="material-icons mdi mdi-message-outline"></i> Sending Message...');
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    submitButton.html('<i class="material-icons mdi mdi-message-outline"></i> Send Message');
                ...
                error: function() {
                    // Re-enable the button and change the text back in case of an error
                    submitButton.prop('disabled', false);
                    submitButton.html('<i class="material-icons mdi mdi-message-outline"></i> Send Message');
                }
            });
